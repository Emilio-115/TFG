...
def make_model_tcn(trial: optuna.Trial, input_shape):
    ...
    dense_units   = hp(16,      lambda t: t.suggest_categorical("tcn_dense_units",  [8, 16, 32, 64]))
    ...
    dilations_key = hp("large", lambda t: t.suggest_categorical("tcn_dilations",    ["small", "medium", "large"]))
